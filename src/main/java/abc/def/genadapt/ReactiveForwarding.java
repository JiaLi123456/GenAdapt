...
import static abc.def.genadapt.OsgiPropertyConstants.FLOW_PRIORITY;
import static abc.def.genadapt.OsgiPropertyConstants.FLOW_PRIORITY_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.FLOW_TIMEOUT;
import static abc.def.genadapt.OsgiPropertyConstants.FLOW_TIMEOUT_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.IGNORE_IPV4_MCAST_PACKETS;
import static abc.def.genadapt.OsgiPropertyConstants.IGNORE_IPV4_MCAST_PACKETS_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.IPV6_FORWARDING;
import static abc.def.genadapt.OsgiPropertyConstants.IPV6_FORWARDING_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_DST_MAC_ONLY;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_DST_MAC_ONLY_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_ICMP_FIELDS;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_ICMP_FIELDS_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_IPV4_ADDRESS;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_IPV4_ADDRESS_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_IPV4_DSCP;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_IPV4_DSCP_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_IPV6_ADDRESS;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_IPV6_ADDRESS_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_IPV6_FLOW_LABEL;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_IPV6_FLOW_LABEL_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_TCP_UDP_PORTS;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_TCP_UDP_PORTS_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_VLAN_ID;
import static abc.def.genadapt.OsgiPropertyConstants.MATCH_VLAN_ID_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.PACKET_OUT_OFPP_TABLE;
import static abc.def.genadapt.OsgiPropertyConstants.PACKET_OUT_OFPP_TABLE_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.PACKET_OUT_ONLY;
import static abc.def.genadapt.OsgiPropertyConstants.PACKET_OUT_ONLY_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.RECORD_METRICS;
import static abc.def.genadapt.OsgiPropertyConstants.RECORD_METRICS_DEFAULT;
import static abc.def.genadapt.OsgiPropertyConstants.INHERIT_FLOW_TREATMENT;
import static abc.def.genadapt.OsgiPropertyConstants.INHERIT_FLOW_TREATMENT_DEFAULT;
...
public class ReactiveForwarding {
    ...
    public void activate(ComponentContext context) {
        ...
        appId = coreService.registerApplication("abc.def.genadapt.1");
        ...
        ////////////////////////////////////////////////////////////////////////
        ////////////////////////////////////////////////////////////////////////
        log.info("Started123456", appId.id());
