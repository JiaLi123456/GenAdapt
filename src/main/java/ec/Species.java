...
public abstract class Species implements Prototype
    ...
    */
    ...
    public void setup(final EvolutionState state, final Parameter base, SearchRunner runner)
        ...
        pipe_prototype.setup(state,base.push(P_PIPE),runner);
