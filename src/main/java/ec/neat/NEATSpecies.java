...
public class NEATSpecies extends GeneVectorSpecies
    ...
    public void setup(EvolutionState state, Parameter base,SearchRunner runner)
        ...
        nodePrototype = (NEATNode) (state.parameters.getInstanceForParameterEq(base.push(P_NODE), def.push(P_NODE),
                NEATNode.class));
        nodePrototype.setup(state, base.push(P_NODE),runner);
        ...
        subspeciesPrototype.setup(state, base.push(P_SUBSPECIES),runner);
        ...
        subspeciesPrototype.setup(state, base.push(P_INNOVATION),runner);
        ...
        networkPrototype.setup(state, base.push(P_NETWORK),runner);
